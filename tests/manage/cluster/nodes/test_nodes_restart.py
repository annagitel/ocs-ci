        ...
        argvalues=[
            pytest.param(
                *['rbd', 'create_resources'],
                marks=[pytest.mark.polarion_id("OCS-1138"), aws_platform_required]
            ),
            pytest.param(
                *['rbd', 'delete_resources'],
                marks=[pytest.mark.polarion_id("OCS-1241"), aws_platform_required]
            ),
            pytest.param(
                *['cephfs', 'create_resources'],
                marks=[pytest.mark.polarion_id("OCS-1139"), aws_platform_required]
            ),
            pytest.param(
                *['cephfs', 'delete_resources'],
                marks=[pytest.mark.polarion_id("OCS-1242"), aws_platform_required]
            )
        ]
    )
